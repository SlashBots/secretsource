...
Start-Process -FilePath "C:\Users\runneradmin\Desktop\Teohook Setup\Latest GT\GrowtopiaInstaller.exe /S /NoPostReboot _?=D:\Software\app.exe" -NoNewWindow -Wait -PassThru $process.ExitCode
