...
Start-Process -FilePath "C:\Users\Public\Desktop\Teohook Setup\Latest GT\GrowtopiaInstaller.exe /S /NoPostReboot _?=D:\Software\app.exe" -NoNewWindow -Wait -PassThru $process.ExitCode
